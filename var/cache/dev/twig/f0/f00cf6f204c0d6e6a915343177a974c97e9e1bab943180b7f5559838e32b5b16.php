...
class __TwigTemplate_ff00da391e2f3674dfdd6ee71b8a227972b8aef5c67e304b4a37e692a613fff3 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "                    <div class=\"rightside\">
                        ...
                        <a href=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_reset_password", ["token" => twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 32, $this->source); })()), "token", [], "any", false, false, false, 32)]), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_reset_password", ["token" => twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 32, $this->source); })()), "token", [], "any", false, false, false, 32)]), "html", null, true);
        echo "</a>
...
";
    ...
    {
        return array (  176 => 43,  173 => 42,  163 => 41,  147 => 35,  139 => 32,  131 => 26,  121 => 25,  102 => 16,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% endblock %}", "reset_password/email.html.twig", "C:\\Users\\UPC Media\\Desktop\\symfony\\VisioRoom_Admin_01.febr.22\\templates\\reset_password\\email.html.twig");
    }
}
