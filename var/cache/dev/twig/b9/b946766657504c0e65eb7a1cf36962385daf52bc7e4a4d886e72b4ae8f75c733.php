...
class __TwigTemplate_5e3e569ed81fd48f354d6677facd9f48af5c943047ac9fe8290c383989d5a6e8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  111 => 15,  107 => 14,  102 => 12,  97 => 10,  93 => 9,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"rightside\">
        <h1 class=\"page__title text--info\">{{ status_code }}</h1>
        <p class=\"page__title file--text\">{{ status_text }}!</p>
        <div class=\"file__image\">
            <img src=\"{{ asset('VisioStyle/assets/img/error.png') }}\" alt=\"\">
        </div>
        <p class=\"page__text text--sorry\">The page you requested return status: - {{ status_text }}.</p>
...
", "@Twig/Exception/error.html.twig", "C:\\Users\\UPC Media\\Desktop\\symfony\\VisioRoom_Admin_01.febr.22\\templates\\bundles\\TwigBundle\\Exception\\error.html.twig");
    }
}
