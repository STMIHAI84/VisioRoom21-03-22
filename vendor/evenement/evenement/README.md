...
[Pimple](http://pimple-project.org), to empower the user while staying concise and simple.
...
**Note:** The `3.x` version of Événement requires PHP 7 and the `2.x` version requires PHP 5.4. If you are using PHP
5.3, please use the `1.x` version:
